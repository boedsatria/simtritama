...
(5, 'Bangunan Non Permanen 10 Tahun', 1.00),
(6, 'Bangunan Permanen 20 Tahun', 1.00);
...
CREATE TABLE `detail_stock` (
  ...
  `item_ds` int(11) NOT NULL,
  `in_ds` int(11) NOT NULL,
  `out_ds` int(11) NOT NULL,
  `user_ds` int(11) NOT NULL,
...
INSERT INTO `detail_stock` (`id_ds`, `item_ds`, `in_ds`, `out_ds`, `user_ds`, `date_ds`) VALUES
(2, 2, 100, 0, 2, '2022-03-01 00:00:00'),
(3, 2, 0, 10, 1, '2022-03-02 00:00:00');
...
(6, 'Piutang sample 1', 3, 23, 0.00, 0.00, 2, '', '2022-03-29 00:00:00', '2022-03-29 00:00:00', 'Auto Generate dari project sample 1 No. Ringkos GLO2329032022', 1);
...
(37, 'Data Vendor', 'list_vendor', 'activity', 3, 5, 1, 1);
...
(23, 'GLO2329032022', 'sample 1', 'Contoh project 1', 0, 0, 3, '111', '2022-03-29', '', '11', '2022-03-29', '', '22', '2022-03-29', '', '33', '2022-03-29', '', 0.00, '2022-03-29 00:00:00', '2022-03-29 00:00:00', 0.00, 0.00, 0.00, 0.00, '2022-03-29', '2022-03-23 15:25:07', 1);
...
CREATE TABLE `stock` (
  ...
  `nama_stock` varchar(128) NOT NULL,
  `level_stock` int(11) NOT NULL,
...
INSERT INTO `stock` (`id_stock`, `nama_stock`, `level_stock`, `status_stock`) VALUES
(1, 'Kertas', 20, 0),
(2, 'Tinta Printer', 1, 0);
...
--
-- Indexes for table `detail_stock`
--
...
--
-- AUTO_INCREMENT for table `detail_stock`
--
ALTER TABLE `detail_stock`
  MODIFY `id_ds` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `hutang_piutang`
  MODIFY `id_hp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
