    ...
    <body class="main">
            ...
            <ul class="border-t border-theme-29 py-5 hidden">
                ...
                <li>
                    <a href="javascript:;.html" class="menu menu--active">
                        ...
                        <div class="menu__title"> Forms <i data-feather="chevron-down" class="menu__sub-icon transform rotate-180"></i> </div>
                    </a>
                    <ul class="menu__sub-open">
                        ...
                        <li>
                            <a href="side-menu-light-datepicker.html" class="menu menu--active">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
        ...
        <div class="flex">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="side-menu__sub-open">
                            ...
                            <li>
                                <a href="pic-e-faktur.html" class="side-menu side-menu--active">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
					...
					<li>
                        ...
                        <ul class="">
                            ...
                            <li>
                                <a href="placement-pembayaran-tagihan.html" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> Pembayaran/Tagihan </div>
                                </a>
                            </li>
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="">Admin/PIC</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">E-Faktur</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-3"> <label>NILAI PPN</label>
                                         <div class="flex flex-col sm:flex-row mt-2">
                                             <div class="form-check mr-2"> <input id="radio-switch-4" 
                                             class="form-check-input" type="radio" name="horizontal_radio_button" value="horizontal-radio-chris-evans">
                                             <label class="form-check-label" for="radio-switch-4">12%</label> </div>
                                             ...
                                             <label class="form-check-label" for="radio-switch-5">11.5%</label> </div>
                                             <input type="text" class="form-control col-span-4" placeholder="Tanggal otomatis dari database" aria-label="default input inline 3">
                                         </div>
                                     </div>
                                    </div>
