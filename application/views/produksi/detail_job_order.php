...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">
        Detail Job Order Produksi <!--JUDUL PAGE-->
    </h2>
</div>
<!-- END JUDUL-->
<div class="grid grid-cols-2 gap-2 mt-5"> <!-- KOLOM BESAR-->
    <div class="intro-y col-span-2 lg:col-span-4"> <!-- KOLOM KIRI-->
        <!-- BEGIN: BLOCK 1 -->
            <div class="intro-y box">
                ...
                <a href="<?= base_url('produksi/pengajuan_produksi') ?>" class="btn btn-primary w-48 mr-2 mb-2"> <i data-feather="search" class="w-4 h-4 mr-2"></i>
                                    Pengajuan HPS </a>
                    </div> 
