            ...
            <div id="input" class="p-5">
                <div class="preview">
                    ...
                    <div class="mt-3">
                        ...
                        <div> <label for="regular-form-1" class="form-label">NILAI KONTRAK</label> <input id="regular-form-1" type="text" class="form-control" placeholder="Input nilai dalam Rupiah"> </div> <br>
