    ...
    <div class="flex flex-col lg:flex-row border-b border-gray-200 dark:border-dark-5 pb-5 -mx-5">
        <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
            <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="<?= base_url() ?>dist/images/profile-4.jpg">
            ...
            <div class="intro-y box col-span-12 lg:col-span-6">
                ...
                <div class="p-5">
                    ...
                    <div class="relative flex items-center mt-5">
                        <div class="w-12 h-12 flex-none image-fit">
                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="<?= base_url() ?>dist/images/profile-5.jpg">
                        </div>
                        <div class="ml-4 mr-auto">
