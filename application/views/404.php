        ...
        <div class="container">
            ...
            <div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
                ...
                <div class="text-white mt-10 lg:mt-0">
                    ...
                    <button class="intro-x btn py-3 px-4 text-white border-white dark:border-dark-5 dark:text-gray-300 mt-10" onclick="window.location.href='index.html'">Kembali ke halaman utama</button>
                </div>
            </div>
            <!-- END: Error Page -->
        </div>
