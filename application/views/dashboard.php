                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-base text-gray-600 mt-1">Project Baru</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-base text-gray-600 mt-1">Project Berjalan</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-base text-gray-600 mt-1">Project Selesai</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                <div class="flex">
                                    ...
                                    <div class="ml-auto">
                                        <div class="report-box__indicator bg-theme-9 tooltip cursor-pointer" title="Total seluruh project"> 100% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                    </div>
                                </div>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                <div class="flex">
                                    ...
                                    <div class="ml-auto">
                                        <div class="report-box__indicator bg-theme-9 tooltip cursor-pointer" title="Target 30%"> - 10% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                    </div>
                                </div>
                                <div class="text-5xl font-extrabold leading-8 mt-6">20%</div>
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                <div class="flex">
                                    <i data-feather="smartphone" class="report-box__icon text-theme-11"></i>
                                    <div class="ml-auto">
                                        <div class="report-box__indicator bg-theme-9 tooltip cursor-pointer" title="Target 30%"> + 15% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                    </div>
                                </div>
                                <div class="text-5xl font-extrabold leading-8 mt-6">45%</div>
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                <div class="flex">
                                    <i data-feather="flag" class="report-box__icon text-theme-12"></i>
                                    <div class="ml-auto">
                                        <div class="report-box__indicator bg-theme-9 tooltip cursor-pointer" title="Target 40%"> - 5% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                    </div>
                                </div>
                                <div class="text-5xl font-extrabold leading-8 mt-6">35%</div>
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                <div class="flex">
                                    <i data-feather="film" class="report-box__icon text-theme-9"></i>
                                    <div class="ml-auto">
                                        <div class="report-box__indicator bg-theme-9 tooltip cursor-pointer" title="Target Final"> 100% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>
                                    </div>
                                </div>
                                <div class="text-5xl font-extrabold leading-8 mt-6">100%</div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">PIC satu</div>
                                <div class="text-gray-600 text-xs mt-0.5">Rp Jumlah total semua project</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">10 Project</div>
                        </div>
                    </div>
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">PIC Dua</div>
                                <div class="text-gray-600 text-xs mt-0.5">Rp Jumlah total semua project</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">8 Project</div>
                        </div>
                    </div>
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">PIC tiga</div>
                                <div class="text-gray-600 text-xs mt-0.5">Rp Jumlah total semua project</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">5 Project</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="mt-5">
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">Nama departement satu</div>
                                <div class="text-gray-600 text-xs mt-0.5">Rp Jumlah total semua project</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">10 Project</div>
                        </div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">Nama departement dua</div>
                                <div class="text-gray-600 text-xs mt-0.5">Rp Jumlah total semua project</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">8 Project</div>
                        </div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">Nama departement tiga</div>
                                <div class="text-gray-600 text-xs mt-0.5">Rp Jumlah total semua project</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">5 Project</div>
                        </div>
                ...
                <div class="mt-5">
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">Nama penyelenggara satu</div>
                                <div class="text-gray-600 text-xs mt-0.5">NIB - KBLI</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">10 Project</div>
                        </div>
                    </div>
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">Nama penyelenggara dua</div>
                                <div class="text-gray-600 text-xs mt-0.5">NIB - KBLI</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">8 Project</div>
                        </div>
                    ...
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">Nama penyelenggara tiga</div>
                                <div class="text-gray-600 text-xs mt-0.5">NIB - KBLI</div>
                            </div>
                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">5 Project</div>
                        </div>
            ...
            <!-- END: TOP 3 CLIENTS -->
                ...
                <div class="intro-y block sm:flex items-center h-10">
                    ...
                    <div class="sm:ml-auto mt-3 sm:mt-0 relative text-gray-700 dark:text-gray-300">
                        ...
                        <input type="text" class="form-control sm:w-40 box pl-10" placeholder="Filter by Clients">
                    </div>
                    <div class="sm:ml-auto mt-3 sm:mt-0 relative text-gray-700 dark:text-gray-300">
                        <i data-feather="map-pin" class="w-4 h-4 z-10 absolute my-auto inset-y-0 ml-3 left-0"></i>
                        <input type="text" class="form-control sm:w-40 box pl-10" placeholder="Filter by PIC">
                    </div>
                    <div class="sm:ml-auto mt-3 sm:mt-0 relative text-gray-700 dark:text-gray-300">
                        <i data-feather="map-pin" class="w-4 h-4 z-10 absolute my-auto inset-y-0 ml-3 left-0"></i>
                        <input type="text" class="form-control sm:w-40 box pl-10" placeholder="Filter by Company">
                    </div>
                    <div class="sm:ml-auto mt-3 sm:mt-0 relative text-gray-700 dark:text-gray-300">
                        <i data-feather="map-pin" class="w-4 h-4 z-10 absolute my-auto inset-y-0 ml-3 left-0"></i>
                        <input type="text" class="form-control sm:w-40 box pl-10" placeholder="Filter by Media">
                    </div>
                </div>
                <div class="intro-y box p-5 mt-12 sm:mt-5">
                    <div>List Project berdasarkan Clients/Direktorat, PIC, Penyelenggara, Media</div>
                                ...
                                <div class="text-gray-600">
                                    ...
                                    <div class="flex mt-2">
                                        ...
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-md border border-white" src="dist/images/preview-11.jpg">
                                        </div>
                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Sony Master Series A9G">
