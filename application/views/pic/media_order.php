 ...
 <!-- END: Nested Select -->
        ...
        <div class="intro-y box">
            ...
            <div class="p-5">
                ...
                <input id="regular-form-5" type="text" class="form-control" placeholder="Otomatis dari database timeline Ringkos" disabled> </div>
        ...
        <div class="intro-y box">
            ...
            <div class="p-5">
                ...
                <input id="regular-form-5" type="text" class="form-control" placeholder="HPS sesuai Pagu Pekerjaan Otomatis dari database Ringkos" disabled> </div>
    ...
    <div class="intro-y col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box">
            ...
            <div class="p-5">
                ...
                <input id="regular-form-5" type="text" class="form-control" placeholder="otomatis sesuai data Ringkos" disabled> </div>
                 <!-- BEGIN: Nested Select -->
