                ...
                <table class="table">
                    ...
                    <tbody class="border-b whitespace-nowrap">
                        <tr>
                            ...
                            <td>11 April 2021</td>
                            <td>
                                <button class="btn btn-success w-48 mr-2 mb-2"> <i data-feather="printer" class="w-4 h-4 mr-2"></i>Print Bukti Bayar </button>
                            </td>
                        </tr>
                        <tr>
                            <td>2</td>
                            ...
                            <td>15 April 2021</td>
                            <td>
                                <button class="btn btn-warning w-48 mr-2 mb-2"> <i data-feather="mail" class="w-4 h-4 mr-2"></i> Kirim Tagihan </button>
                            </td>
                        </tr>
                    </tbody>
                </table>
